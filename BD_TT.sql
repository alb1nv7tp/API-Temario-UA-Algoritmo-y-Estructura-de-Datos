...
CREATE TABLE Reportes (
    ...
    idDocumento         INT             NOT NULL,
    tipoUsuarioReporta  ENUM('alumno','profesor','administrador') NOT NULL,
    idUsuarioReporta    VARCHAR(25)     NOT NULL, 
    asunto              VARCHAR(150)    NOT NULL,
    descripcion         TEXT            NOT NULL,
    
    -- NUEVOS CAMPOS PARA LA RESOLUCIÓN
    respuestaAdmin      TEXT            DEFAULT NULL COMMENT 'Pasos realizados por el administrador para solucionar el reporte',
    idAdminResolutor    INT             DEFAULT NULL COMMENT 'ID del administrador que atendió el reporte',
    
    fechaCreacion       DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP,
    fechaFinalizacion   DATETIME        DEFAULT NULL,
    estatus             TINYINT(1)      NOT NULL DEFAULT 1 COMMENT '1 = Pendiente/Activo, 0 = Resuelto/Cerrado',
    
    PRIMARY KEY (idReporte),
    FOREIGN KEY (idDocumento) REFERENCES Documentos(idDocumento)
        ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (idAdminResolutor) REFERENCES Administradores(idAdmin)
